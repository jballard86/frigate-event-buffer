...
-   **GenAI Integration**: Captures and displays AI-generated titles, descriptions, and threat levels from Frigate (reviews and tracked object updates). Optionally, when the buffer's Gemini analyzer is enabled in config, it can analyze clips in-process and persist results via the Frigate API and notify Home Assistant.
